...
const Contact = () => {
  return (
    <section
      id="contact"
      className="relative z-10 w-full py-24 px-6 md:px-12 bg-transparent border-t border-emerald-500/20"
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-slate-300 text-lg mb-12 max-w-2xl mx-auto font-light leading-relaxed">
          Saat ini saya terbuka untuk peluang karier profesional (Full-time) maupun kolaborasi proyek lepas (Freelance). Baik itu pengembangan arsitektur web modern, integrasi kecerdasan buatan, atau sekadar diskusi seputar teknologi, mari terhubung dan ciptakan dampak nyata!
        </p>
